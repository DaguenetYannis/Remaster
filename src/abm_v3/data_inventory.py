...
def build_semantic_variable_map_rows() -> list[dict[str, str]]:
    ...
    missing = "missing_or_not_yet_constructed"
    ...
    rows = [
        ...
        semantic_row("g_local", "g_local; local_green_ness; greenness", "local_green_ness", "Available local green-ness proxy for the node's own production state.", phase_panel, state_panel, "country_sector-year", "annual", "high", "high", "high", "high", "green_up_axis", "Higher values indicate greener local production conditions under the available proxy; this remains distinct from network greenness.", "Use the observed g_local column when present. If missing, the phase-space builder may derive a fallback and will record the formula in diagnostics and the columns dictionary.", "required"),
        ...
        semantic_row("capability_ecosystem_exposure", "capability_ecosystem_exposure; ecosystem_exposure", "ecosystem_readiness", "Design-target measure for exposure to nearby capability ecosystems that may support transition.", missing, atlas_panel, "country_sector-year", "annual", "high", "high", "high", "high", "y_axis", "Would represent product-space readiness rather than observed greening once constructed.", "Currently missing as a canonical state-panel variable; construct later from validated Atlas/product-space inputs.", "high"),
        ...
        semantic_row("network_green_exposure", "network_green_exposure; network_green_ness", "network_green_ness", "Canonical target concept for aggregate network-embedded green exposure around the node.", missing, "g_in_network; g_out_network", "country_sector-year", "annual", "high", "high", "high", "high", "z_axis", "Target aggregate network green-ness concept, distinct from local green-ness and directional network proxies.", "Currently missing as a canonical aggregate variable; use available g_in_network or g_out_network variants until a validated aggregate is constructed.", "high"),
        semantic_row("g_in_network", "g_in_network; incoming_green", "network_green_ness", "Available input-side or upstream directional network green-ness variable.", phase_panel, diagnostics, "country_sector-year", "annual", "high", "high", "medium", "high", "z_axis_available_variant", "Captures green-ness of suppliers or incoming production links.", "Available directional proxy; interpretation depends on validated input-output orientation.", "high"),
        semantic_row("g_out_network", "g_out_network; outgoing_green", "network_green_ness", "Available output-side or downstream directional network green-ness variable.", phase_panel, diagnostics, "country_sector-year", "annual", "high", "high", "medium", "high", "z_axis_available_variant", "Captures green-ness of buyers or downstream production links.", "Available directional proxy; interpretation depends on validated input-output orientation.", "high"),
        ...
        semantic_row("brown_centrality", "brown_centrality; embodied_carbon_centrality", "brown_centrality", "Design-target centrality weighted by brown or carbon-intensive network exposure.", missing, diagnostics, "country_sector-year", "annual", "high", "high", "medium", "high", "x_axis", "Would proxy brown lock-in in the network, distinct from own EI, once constructed.", "Currently missing as a canonical state-panel variable; construct later from validated centrality and carbon-intensity layers.", "high"),
...
def build_visual_use_map_rows() -> list[dict[str, str]]:
    ...
    rows = [
        ...
        visual_row(
            "3D phase-space cubes: Green Transition Readiness Cube, g_in_network variant",
            "Where are nodes with green capability, improving local greenness, and upstream green network exposure?",
            phase_panel,
            "green_capability; g_local; g_in_network",
            "X_observed; EI; emissions_observed",
            "country_sector-year",
            "node panel or weighted aggregate",
            "X_observed",
            ...
            "medium",
            "high",
            "Available-axis variant: X = green capability; Y = local greenness, green up; Z = g_in_network.",
        ),
        visual_row(
            "3D phase-space cubes: Green Transition Readiness Cube, g_out_network variant",
            "Where are nodes with green capability, improving local greenness, and downstream green network exposure?",
            phase_panel,
            "green_capability; g_local; g_out_network",
            "X_observed; EI; emissions_observed",
            "country_sector-year",
            "node panel or weighted aggregate",
            "X_observed",
            ...
            "medium",
            "high",
            "Available-axis variant: X = green capability; Y = local greenness, green up; Z = g_out_network.",
        ),
        visual_row(
        ...
        visual_row(
            "3D phase-space cubes: Production-Safe Greening Cube, g_in_network variant",
            "Can greening be read alongside production scale and upstream green network exposure?",
            phase_panel,
            "X_observed or log_X_observed; g_local; g_in_network",
            "green_capability; EI; emissions_observed",
            "country_sector-year",
            "node panel or sector aggregate",
            "X_observed",
            ...
            "medium",
            "high",
            "Available-axis variant: X = production scale/log output; Y = local greenness, green up; Z = g_in_network.",
        ),
        visual_row(
            "3D phase-space cubes: Production-Safe Greening Cube, g_out_network variant",
            "Can greening be read alongside production scale and downstream green network exposure?",
            phase_panel,
            "X_observed or log_X_observed; g_local; g_out_network",
            "green_capability; EI; emissions_observed",
            "country_sector-year",
            "node panel or sector aggregate",
            "X_observed",
            ...
            "medium",
            "high",
            "Available-axis variant: X = production scale/log output; Y = local greenness, green up; Z = g_out_network.",
        ),
        visual_row(
        ...
        visual_row(
            "Vector-field plots: local green-ness movement conditional on capability and g_in_network",
            "Does local greenness improve where capability and upstream green network exposure are high?",
            phase_panel,
            "green_capability; g_in_network; delta_g_local",
            "delta_log_EI; X_observed weights; emissions weights",
            "country_sector-year movement",
            "binned capability-upstream-network space",
            "X_observed",
            "medium",
            "high",
            "high",
            "medium",
            "Available-axis variant using g_in_network until aggregate network_green_exposure is constructed.",
        ),
        visual_row(
            "Vector-field plots: local green-ness movement conditional on capability and g_out_network",
            "Does local greenness improve where capability and downstream green network exposure are high?",
            phase_panel,
            "green_capability; g_out_network; delta_g_local",
            "delta_log_EI; X_observed weights; emissions weights",
            "country_sector-year movement",
            "binned capability-downstream-network space",
            "X_observed",
            "medium",
            "high",
            "high",
            "medium",
            "Available-axis variant using g_out_network until aggregate network_green_exposure is constructed.",
        ),
        visual_row(
